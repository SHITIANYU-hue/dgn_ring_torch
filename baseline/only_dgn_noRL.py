...
def idm_constrain_action(state):
    ...
    accels= a * (1 - (veh_speed)**delta - (s_star / h)**2)
...
for i_episode in range(num_runs):
    ...
    for j in range(num_steps):
        ...
        actions = idm_constrain_action(state_)
    ...
    np.save(os.path.join(results_dir, 'lane_pos.npy'), LANE_POS)
